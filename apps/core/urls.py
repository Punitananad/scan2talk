...
urlpatterns = [
    ...
    path('order-tag/', views.OrderTagView.as_view(), name='order_tag'),
    path('order-tag/payment/', views.OrderPaymentView.as_view(), name='order_payment'),
    path('order-tag/success/', views.OrderSuccessView.as_view(), name='order_success'),
